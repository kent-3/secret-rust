...
/// MintParamsResponseParams : params defines the parameters of the module.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct MintParamsResponseParams {
...
impl MintParamsResponseParams {
    /// params defines the parameters of the module.
    pub fn new() -> MintParamsResponseParams {
        MintParamsResponseParams {
            mint_denom: None,
