...
pub struct ValidatorsetsLatestGetResponseValidatorsInner {
...
impl ValidatorsetsLatestGetResponseValidatorsInner {
    pub fn new() -> ValidatorsetsLatestGetResponseValidatorsInner {
        ValidatorsetsLatestGetResponseValidatorsInner {
            address: None,
            pub_key: None,
            voting_power: None,
