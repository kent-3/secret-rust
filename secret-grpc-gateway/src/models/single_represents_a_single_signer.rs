...
pub struct SingleRepresentsASingleSigner {
...
impl SingleRepresentsASingleSigner {
    pub fn new() -> SingleRepresentsASingleSigner {
        SingleRepresentsASingleSigner { mode: None }
    }
}
