...
/// CosmosBankV1beta1DenomUnit : DenomUnit represents a struct that describes a given denomination unit of the basic token.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct CosmosBankV1beta1DenomUnit {
...
impl CosmosBankV1beta1DenomUnit {
    /// DenomUnit represents a struct that describes a given denomination unit of the basic token.
    pub fn new() -> CosmosBankV1beta1DenomUnit {
