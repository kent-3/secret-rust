...
pub struct BlocksLatestGetResponseBlockMetaHeader {
...
impl BlocksLatestGetResponseBlockMetaHeader {
    pub fn new() -> BlocksLatestGetResponseBlockMetaHeader {
        BlocksLatestGetResponseBlockMetaHeader {
            chain_id: None,
            height: None,
            time: None,
            num_txs: None,
