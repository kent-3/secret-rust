...
pub struct SlashingSigningInfosGetResponseInner {
...
impl SlashingSigningInfosGetResponseInner {
    pub fn new() -> SlashingSigningInfosGetResponseInner {
        SlashingSigningInfosGetResponseInner {
            start_height: None,
            index_offset: None,
            jailed_until: None,
