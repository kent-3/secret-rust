...
/// HistoricalInfoResponseHistHeader : Header defines the structure of a Tendermint block header.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct HistoricalInfoResponseHistHeader {
    ...
    pub last_block_id: Option<Box<crate::models::PrevBlockInfo>>,
...
impl HistoricalInfoResponseHistHeader {
    /// Header defines the structure of a Tendermint block header.
    pub fn new() -> HistoricalInfoResponseHistHeader {
