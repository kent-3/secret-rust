...
/// GetTxsEventResponseTxsInner : Tx is the standard type used for broadcasting transactions.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetTxsEventResponseTxsInner {
...
impl GetTxsEventResponseTxsInner {
    /// Tx is the standard type used for broadcasting transactions.
    pub fn new() -> GetTxsEventResponseTxsInner {
