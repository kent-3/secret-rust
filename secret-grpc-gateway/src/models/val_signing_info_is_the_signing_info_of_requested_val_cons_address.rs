...
/// ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress : ValidatorSigningInfo defines a validator's signing info for monitoring their liveness activity.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress {
...
impl ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress {
    /// ValidatorSigningInfo defines a validator's signing info for monitoring their liveness activity.
    pub fn new() -> ValSigningInfoIsTheSigningInfoOfRequestedValConsAddress {
