...
/// AuthParamsResponseParams : params defines the parameters of the module.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct AuthParamsResponseParams {
    #[serde(
...
impl AuthParamsResponseParams {
    /// params defines the parameters of the module.
    pub fn new() -> AuthParamsResponseParams {
