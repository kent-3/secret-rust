...
/// GetLatestBlockResponseBlockEvidenceEvidenceInnerDuplicateVoteEvidenceVoteA : Vote represents a prevote, precommit, or commit vote from validators for consensus.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct GetLatestBlockResponseBlockEvidenceEvidenceInnerDuplicateVoteEvidenceVoteA {
...
impl GetLatestBlockResponseBlockEvidenceEvidenceInnerDuplicateVoteEvidenceVoteA {
    /// Vote represents a prevote, precommit, or commit vote from validators for consensus.
    pub fn new() -> GetLatestBlockResponseBlockEvidenceEvidenceInnerDuplicateVoteEvidenceVoteA {
