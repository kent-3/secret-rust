...
pub struct GovProposalsGetResponseInnerFinalTallyResult {
...
impl GovProposalsGetResponseInnerFinalTallyResult {
    pub fn new() -> GovProposalsGetResponseInnerFinalTallyResult {
        GovProposalsGetResponseInnerFinalTallyResult {
            r#true: None,
            abstain: None,
            r#false: None,
            no_with_veto: None,
