...
/// DelegatorDelegationsResponse : QueryDelegatorDelegationsResponse is response type for the Query/DelegatorDelegations RPC method.
...
impl DelegatorDelegationsResponse {
    /// QueryDelegatorDelegationsResponse is response type for the Query/DelegatorDelegations RPC method.
    pub fn new() -> DelegatorDelegationsResponse {
