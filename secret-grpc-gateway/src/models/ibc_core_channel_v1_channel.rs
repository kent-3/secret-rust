...
/// IbcCoreChannelV1Channel : Channel defines pipeline for exactly-once packet delivery between specific modules on separate blockchains, which has at least one end capable of sending packets and one end capable of receiving packets.

#[derive(Clone, Debug, PartialEq, Serialize, Deserialize)]
pub struct IbcCoreChannelV1Channel {
...
impl IbcCoreChannelV1Channel {
    /// Channel defines pipeline for exactly-once packet delivery between specific modules on separate blockchains, which has at least one end capable of sending packets and one end capable of receiving packets.
    pub fn new() -> IbcCoreChannelV1Channel {
