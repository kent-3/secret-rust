...
//! Secret Network full node (localsecret) running inside of Docker.
...
/// [`localsecret`], the reference implementation of a Cosmos Hub full node.
///
/// [`localsecret`]: https://github.com/scrtlabs/LocalSecret
