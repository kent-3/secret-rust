...
pub struct Params {
    ...
    /// code.
    #[prost(string, tag = "1")]
    pub compile_cost: ::prost::alloc::string::String,
...
impl ::prost::Name for Params {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "secret.compute.v1beta1.Params".into()
    }
...
impl ::prost::Name for MsgUpdateParams {
    ...
    const PACKAGE: &'static str = "secret.compute.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "secret.compute.v1beta1.MsgUpdateParams".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/secret.compute.v1beta1.MsgUpdateParams".into()
    }
...
impl ::prost::Name for MsgUpdateParamsResponse {
    ...
    const PACKAGE: &'static str = "secret.compute.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "secret.compute.v1beta1.MsgUpdateParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/secret.compute.v1beta1.MsgUpdateParamsResponse".into()
    }
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        ) -> std::result::Result<tonic::Response<super::MsgUpdateParamsResponse>, tonic::Status>
        {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path =
                http::uri::PathAndQuery::from_static("/secret.compute.v1beta1.Msg/UpdateParams");
            let mut req = request.into_request();
            req.extensions_mut().insert(GrpcMethod::new(
                "secret.compute.v1beta1.Msg",
                "UpdateParams",
...
impl ::prost::Name for ParamsRequest {
    ...
    const PACKAGE: &'static str = "secret.compute.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "secret.compute.v1beta1.ParamsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/secret.compute.v1beta1.ParamsRequest".into()
    }
...
impl ::prost::Name for ParamsResponse {
    ...
    const PACKAGE: &'static str = "secret.compute.v1beta1";
    fn full_name() -> ::prost::alloc::string::String {
        "secret.compute.v1beta1.ParamsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/secret.compute.v1beta1.ParamsResponse".into()
    }
...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn params(
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static("/secret.compute.v1beta1.Query/Params");
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("secret.compute.v1beta1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
    }
}
